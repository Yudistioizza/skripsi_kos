        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('')" class="grid">
                    ...
                    <flux:navlist.item icon="banknotes" :href="route('laporan.keuangan')" :current="request()->routeIs('laporan.keuangan')" wire:navigate>{{ __('Laporan Keuangan') }}</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
